...
var CallbacksContext = React__default.createContext({
...
var VectorHeightContext = React__default.createContext(0);
var VectorWidthContext = React__default.createContext(0);
var ScaleContext = React__default.createContext(1);
  ...
  _createClass(ShapeEditor, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("svg", _extends({
        ...
        ,
        focusable: false
      }, otherProps), React__default.createElement(CallbacksContext.Provider, {
        value: this.callbacks
      }, React__default.createElement(VectorHeightContext.Provider, {
        value: vectorHeight
      }, React__default.createElement(VectorWidthContext.Provider, {
        value: vectorWidth
      }, React__default.createElement(ScaleContext.Provider, {
        value: scale
      }, children)))));
    }
  }]);
...
function withContext(Component) {
  function ComponentWithRseContext(props, ref) {
    var callbacks = React.useContext(CallbacksContext);
    var vectorHeight = React.useContext(VectorHeightContext);
    var vectorWidth = React.useContext(VectorWidthContext);
    var scale = React.useContext(ScaleContext);
    return React__default.createElement(Component, _extends({}, props, callbacks, {
      callbacks: callbacks,
  ...
  return React__default.forwardRef(ComponentWithRseContext);
}
  ...
  function (_React$PureComponent) {
    ...
    _createClass(WrappedShape, [{
      ...
      value: function render() {
        ...
        handles.push(React__default.createElement(RotateHandleComponent, {
          key: "rotate-handle",
          name: "rotate-handle",
          active: active,
          nativeActive: nativeActive,
...
function (_Component) {
  ...
  _createClass(DrawLayer, [{
    ...
    value: function render() {
      ...
      }), isMouseDown && React__default.createElement(DrawPreviewComponent, {
...
function (_Component) {
  ...
  _createClass(SelectionLayer, [{
    ...
    value: function render() {
      ...
      if (isMouseDown) {
        if (this.selectionIsLargeEnough()) {
          extra = React__default.createElement(SelectionDrawComponent, {
        ...
        extra = React__default.createElement(SelectionComponent, _extends({
      ...
      }), React__default.createElement(CallbacksContext.Provider, {
        value: this.callbacks
      }, React__default.createElement(React__default.Fragment, null, children, extra)));
    }
  }]);
...
exports.DrawLayer = DrawLayer$1;
exports.ImageLayer = ImageLayer;
exports.SelectionLayer = SelectionLayer$1;
exports.ShapeEditor = ShapeEditor;
exports.wrapShape = wrapShape;
